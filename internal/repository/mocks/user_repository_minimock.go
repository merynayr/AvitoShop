...
type UserRepositoryMock struct {
	...
	funcIsExistByID          func(ctx context.Context, userID int64) (b1 bool, err error)
	funcIsExistByIDOrigin    string
	inspectFuncIsExistByID   func(ctx context.Context, userID int64)
	afterIsExistByIDCounter  uint64
	beforeIsExistByIDCounter uint64
	IsExistByIDMock          mUserRepositoryMockIsExistByID
...
func NewUserRepositoryMock(t minimock.Tester) *UserRepositoryMock {
	...
	m.IsExistByIDMock = mUserRepositoryMockIsExistByID{mock: m}
	m.IsExistByIDMock.callArgs = []*UserRepositoryMockIsExistByIDParams{}
...
type mUserRepositoryMockIsExistByID struct {
	optional           bool
	mock               *UserRepositoryMock
	defaultExpectation *UserRepositoryMockIsExistByIDExpectation
	expectations       []*UserRepositoryMockIsExistByIDExpectation

	callArgs []*UserRepositoryMockIsExistByIDParams
	mutex    sync.RWMutex
...
// UserRepositoryMockIsExistByIDExpectation specifies expectation struct of the UserRepository.IsExistByID
type UserRepositoryMockIsExistByIDExpectation struct {
	mock               *UserRepositoryMock
	params             *UserRepositoryMockIsExistByIDParams
	paramPtrs          *UserRepositoryMockIsExistByIDParamPtrs
	expectationOrigins UserRepositoryMockIsExistByIDExpectationOrigins
	results            *UserRepositoryMockIsExistByIDResults
	returnOrigin       string
	Counter            uint64
}

// UserRepositoryMockIsExistByIDParams contains parameters of the UserRepository.IsExistByID
type UserRepositoryMockIsExistByIDParams struct {
	ctx    context.Context
	userID int64
}

// UserRepositoryMockIsExistByIDParamPtrs contains pointers to parameters of the UserRepository.IsExistByID
type UserRepositoryMockIsExistByIDParamPtrs struct {
	ctx    *context.Context
	userID *int64
}

// UserRepositoryMockIsExistByIDResults contains results of the UserRepository.IsExistByID
type UserRepositoryMockIsExistByIDResults struct {
	b1  bool
	err error
}

// UserRepositoryMockIsExistByIDOrigins contains origins of expectations of the UserRepository.IsExistByID
type UserRepositoryMockIsExistByIDExpectationOrigins struct {
	origin       string
	originCtx    string
	originUserID string
}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmIsExistByID *mUserRepositoryMockIsExistByID) Optional() *mUserRepositoryMockIsExistByID {
	mmIsExistByID.optional = true
	return mmIsExistByID
}

// Expect sets up expected params for UserRepository.IsExistByID
func (mmIsExistByID *mUserRepositoryMockIsExistByID) Expect(ctx context.Context, userID int64) *mUserRepositoryMockIsExistByID {
	if mmIsExistByID.mock.funcIsExistByID != nil {
		mmIsExistByID.mock.t.Fatalf("UserRepositoryMock.IsExistByID mock is already set by Set")
	}

	if mmIsExistByID.defaultExpectation == nil {
		mmIsExistByID.defaultExpectation = &UserRepositoryMockIsExistByIDExpectation{}
	}

	if mmIsExistByID.defaultExpectation.paramPtrs != nil {
		mmIsExistByID.mock.t.Fatalf("UserRepositoryMock.IsExistByID mock is already set by ExpectParams functions")
	}

	mmIsExistByID.defaultExpectation.params = &UserRepositoryMockIsExistByIDParams{ctx, userID}
	mmIsExistByID.defaultExpectation.expectationOrigins.origin = minimock.CallerInfo(1)
	for _, e := range mmIsExistByID.expectations {
		if minimock.Equal(e.params, mmIsExistByID.defaultExpectation.params) {
			mmIsExistByID.mock.t.Fatalf("Expectation set by When has same params: %#v", *mmIsExistByID.defaultExpectation.params)
		}
	}
...
// ExpectCtxParam1 sets up expected param ctx for UserRepository.IsExistByID
func (mmIsExistByID *mUserRepositoryMockIsExistByID) ExpectCtxParam1(ctx context.Context) *mUserRepositoryMockIsExistByID {
	if mmIsExistByID.mock.funcIsExistByID != nil {
		mmIsExistByID.mock.t.Fatalf("UserRepositoryMock.IsExistByID mock is already set by Set")
	}
	...
	if mmIsExistByID.defaultExpectation.params != nil {
		mmIsExistByID.mock.t.Fatalf("UserRepositoryMock.IsExistByID mock is already set by Expect")
	}

	if mmIsExistByID.defaultExpectation.paramPtrs == nil {
		mmIsExistByID.defaultExpectation.paramPtrs = &UserRepositoryMockIsExistByIDParamPtrs{}
	}
	mmIsExistByID.defaultExpectation.paramPtrs.ctx = &ctx
	mmIsExistByID.defaultExpectation.expectationOrigins.originCtx = minimock.CallerInfo(1)

	return mmIsExistByID
}

// ExpectUserIDParam2 sets up expected param userID for UserRepository.IsExistByID
func (mmIsExistByID *mUserRepositoryMockIsExistByID) ExpectUserIDParam2(userID int64) *mUserRepositoryMockIsExistByID {
	if mmIsExistByID.mock.funcIsExistByID != nil {
		mmIsExistByID.mock.t.Fatalf("UserRepositoryMock.IsExistByID mock is already set by Set")
	}
	...
	mmIsExistByID.defaultExpectation.paramPtrs.userID = &userID
	mmIsExistByID.defaultExpectation.expectationOrigins.originUserID = minimock.CallerInfo(1)

	return mmIsExistByID
}

// Inspect accepts an inspector function that has same arguments as the UserRepository.IsExistByID
func (mmIsExistByID *mUserRepositoryMockIsExistByID) Inspect(f func(ctx context.Context, userID int64)) *mUserRepositoryMockIsExistByID {
	if mmIsExistByID.mock.inspectFuncIsExistByID != nil {
		mmIsExistByID.mock.t.Fatalf("Inspect function is already set for UserRepositoryMock.IsExistByID")
	}

	mmIsExistByID.mock.inspectFuncIsExistByID = f

	return mmIsExistByID
}

// Return sets up results that will be returned by UserRepository.IsExistByID
func (mmIsExistByID *mUserRepositoryMockIsExistByID) Return(b1 bool, err error) *UserRepositoryMock {
	if mmIsExistByID.mock.funcIsExistByID != nil {
		mmIsExistByID.mock.t.Fatalf("UserRepositoryMock.IsExistByID mock is already set by Set")
	}

	if mmIsExistByID.defaultExpectation == nil {
		mmIsExistByID.defaultExpectation = &UserRepositoryMockIsExistByIDExpectation{mock: mmIsExistByID.mock}
	}
	mmIsExistByID.defaultExpectation.results = &UserRepositoryMockIsExistByIDResults{b1, err}
	mmIsExistByID.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmIsExistByID.mock
}

// Set uses given function f to mock the UserRepository.IsExistByID method
func (mmIsExistByID *mUserRepositoryMockIsExistByID) Set(f func(ctx context.Context, userID int64) (b1 bool, err error)) *UserRepositoryMock {
	if mmIsExistByID.defaultExpectation != nil {
		mmIsExistByID.mock.t.Fatalf("Default expectation is already set for the UserRepository.IsExistByID method")
	}

	if len(mmIsExistByID.expectations) > 0 {
		mmIsExistByID.mock.t.Fatalf("Some expectations are already set for the UserRepository.IsExistByID method")
	}

	mmIsExistByID.mock.funcIsExistByID = f
	mmIsExistByID.mock.funcIsExistByIDOrigin = minimock.CallerInfo(1)
	return mmIsExistByID.mock
}

// When sets expectation for the UserRepository.IsExistByID which will trigger the result defined by the following
// Then helper
func (mmIsExistByID *mUserRepositoryMockIsExistByID) When(ctx context.Context, userID int64) *UserRepositoryMockIsExistByIDExpectation {
	if mmIsExistByID.mock.funcIsExistByID != nil {
		mmIsExistByID.mock.t.Fatalf("UserRepositoryMock.IsExistByID mock is already set by Set")
	}

	expectation := &UserRepositoryMockIsExistByIDExpectation{
		mock:               mmIsExistByID.mock,
		params:             &UserRepositoryMockIsExistByIDParams{ctx, userID},
		expectationOrigins: UserRepositoryMockIsExistByIDExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
	mmIsExistByID.expectations = append(mmIsExistByID.expectations, expectation)
	return expectation
}

// Then sets up UserRepository.IsExistByID return parameters for the expectation previously defined by the When method
func (e *UserRepositoryMockIsExistByIDExpectation) Then(b1 bool, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockIsExistByIDResults{b1, err}
	return e.mock
}

// Times sets number of times UserRepository.IsExistByID should be invoked
func (mmIsExistByID *mUserRepositoryMockIsExistByID) Times(n uint64) *mUserRepositoryMockIsExistByID {
	if n == 0 {
		mmIsExistByID.mock.t.Fatalf("Times of UserRepositoryMock.IsExistByID mock can not be zero")
	}
	mm_atomic.StoreUint64(&mmIsExistByID.expectedInvocations, n)
	mmIsExistByID.expectedInvocationsOrigin = minimock.CallerInfo(1)
	return mmIsExistByID
}

func (mmIsExistByID *mUserRepositoryMockIsExistByID) invocationsDone() bool {
	if len(mmIsExistByID.expectations) == 0 && mmIsExistByID.defaultExpectation == nil && mmIsExistByID.mock.funcIsExistByID == nil {
		return true
	}

	totalInvocations := mm_atomic.LoadUint64(&mmIsExistByID.mock.afterIsExistByIDCounter)
	expectedInvocations := mm_atomic.LoadUint64(&mmIsExistByID.expectedInvocations)

	return totalInvocations > 0 && (expectedInvocations == 0 || expectedInvocations == totalInvocations)
}

// IsExistByID implements mm_repository.UserRepository
func (mmIsExistByID *UserRepositoryMock) IsExistByID(ctx context.Context, userID int64) (b1 bool, err error) {
	mm_atomic.AddUint64(&mmIsExistByID.beforeIsExistByIDCounter, 1)
	defer mm_atomic.AddUint64(&mmIsExistByID.afterIsExistByIDCounter, 1)

	mmIsExistByID.t.Helper()

	if mmIsExistByID.inspectFuncIsExistByID != nil {
		mmIsExistByID.inspectFuncIsExistByID(ctx, userID)
	}

	mm_params := UserRepositoryMockIsExistByIDParams{ctx, userID}

	// Record call args
	mmIsExistByID.IsExistByIDMock.mutex.Lock()
	mmIsExistByID.IsExistByIDMock.callArgs = append(mmIsExistByID.IsExistByIDMock.callArgs, &mm_params)
	mmIsExistByID.IsExistByIDMock.mutex.Unlock()

	for _, e := range mmIsExistByID.IsExistByIDMock.expectations {
		if minimock.Equal(*e.params, mm_params) {
			mm_atomic.AddUint64(&e.Counter, 1)
	...
	if mmIsExistByID.IsExistByIDMock.defaultExpectation != nil {
		mm_atomic.AddUint64(&mmIsExistByID.IsExistByIDMock.defaultExpectation.Counter, 1)
		mm_want := mmIsExistByID.IsExistByIDMock.defaultExpectation.params
		mm_want_ptrs := mmIsExistByID.IsExistByIDMock.defaultExpectation.paramPtrs

		mm_got := UserRepositoryMockIsExistByIDParams{ctx, userID}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmIsExistByID.t.Errorf("UserRepositoryMock.IsExistByID got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmIsExistByID.IsExistByIDMock.defaultExpectation.expectationOrigins.originCtx, *mm_want_ptrs.ctx, mm_got.ctx, minimock.Diff(*mm_want_ptrs.ctx, mm_got.ctx))
			}

			if mm_want_ptrs.userID != nil && !minimock.Equal(*mm_want_ptrs.userID, mm_got.userID) {
				mmIsExistByID.t.Errorf("UserRepositoryMock.IsExistByID got unexpected parameter userID, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmIsExistByID.IsExistByIDMock.defaultExpectation.expectationOrigins.originUserID, *mm_want_ptrs.userID, mm_got.userID, minimock.Diff(*mm_want_ptrs.userID, mm_got.userID))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmIsExistByID.t.Errorf("UserRepositoryMock.IsExistByID got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
				mmIsExistByID.IsExistByIDMock.defaultExpectation.expectationOrigins.origin, *mm_want, mm_got, minimock.Diff(*mm_want, mm_got))
		}

		mm_results := mmIsExistByID.IsExistByIDMock.defaultExpectation.results
		if mm_results == nil {
			mmIsExistByID.t.Fatal("No results are set for the UserRepositoryMock.IsExistByID")
		}
		return (*mm_results).b1, (*mm_results).err
	}
	if mmIsExistByID.funcIsExistByID != nil {
		return mmIsExistByID.funcIsExistByID(ctx, userID)
	}
	mmIsExistByID.t.Fatalf("Unexpected call to UserRepositoryMock.IsExistByID. %v %v", ctx, userID)
	return
}

// IsExistByIDAfterCounter returns a count of finished UserRepositoryMock.IsExistByID invocations
func (mmIsExistByID *UserRepositoryMock) IsExistByIDAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmIsExistByID.afterIsExistByIDCounter)
}

// IsExistByIDBeforeCounter returns a count of UserRepositoryMock.IsExistByID invocations
func (mmIsExistByID *UserRepositoryMock) IsExistByIDBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmIsExistByID.beforeIsExistByIDCounter)
}

// Calls returns a list of arguments used in each call to UserRepositoryMock.IsExistByID.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmIsExistByID *mUserRepositoryMockIsExistByID) Calls() []*UserRepositoryMockIsExistByIDParams {
	mmIsExistByID.mutex.RLock()

	argCopy := make([]*UserRepositoryMockIsExistByIDParams, len(mmIsExistByID.callArgs))
	copy(argCopy, mmIsExistByID.callArgs)

	mmIsExistByID.mutex.RUnlock()

	return argCopy
}

// MinimockIsExistByIDDone returns true if the count of the IsExistByID invocations corresponds
// the number of defined expectations
func (m *UserRepositoryMock) MinimockIsExistByIDDone() bool {
	if m.IsExistByIDMock.optional {
		// Optional methods provide '0 or more' call count restriction.
		return true
	}

	for _, e := range m.IsExistByIDMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			return false
		}
	}

	return m.IsExistByIDMock.invocationsDone()
}

// MinimockIsExistByIDInspect logs each unmet expectation
func (m *UserRepositoryMock) MinimockIsExistByIDInspect() {
	for _, e := range m.IsExistByIDMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to UserRepositoryMock.IsExistByID at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}

	afterIsExistByIDCounter := mm_atomic.LoadUint64(&m.afterIsExistByIDCounter)
	// if default expectation was set then invocations count should be greater than zero
	if m.IsExistByIDMock.defaultExpectation != nil && afterIsExistByIDCounter < 1 {
		if m.IsExistByIDMock.defaultExpectation.params == nil {
			m.t.Errorf("Expected call to UserRepositoryMock.IsExistByID at\n%s", m.IsExistByIDMock.defaultExpectation.returnOrigin)
		} else {
			m.t.Errorf("Expected call to UserRepositoryMock.IsExistByID at\n%s with params: %#v", m.IsExistByIDMock.defaultExpectation.expectationOrigins.origin, *m.IsExistByIDMock.defaultExpectation.params)
		}
	}
	// if func was set then invocations count should be greater than zero
	if m.funcIsExistByID != nil && afterIsExistByIDCounter < 1 {
		m.t.Errorf("Expected call to UserRepositoryMock.IsExistByID at\n%s", m.funcIsExistByIDOrigin)
	}

	if !m.IsExistByIDMock.invocationsDone() && afterIsExistByIDCounter > 0 {
		m.t.Errorf("Expected %d calls to UserRepositoryMock.IsExistByID at\n%s but found %d calls",
			mm_atomic.LoadUint64(&m.IsExistByIDMock.expectedInvocations), m.IsExistByIDMock.expectedInvocationsOrigin, afterIsExistByIDCounter)
	}
}
